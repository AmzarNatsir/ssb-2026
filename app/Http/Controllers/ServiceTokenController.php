...
class ServiceTokenController extends Controller
{
                ...
                new OA\Property(
                    ...
                    items: new OA\Items(
                        properties: [
                            ...
                            new OA\Property(property: 'app_name', type: 'string', example: 'Aplikasi HRD External'),
                            ...
                            new OA\Property(property: 'last_used_at', type: 'string', nullable: true, example: '2026-05-15 08:00:00'),
                            new OA\Property(property: 'created_at', type: 'string', example: '2026-05-15 07:00:00'),
                        ]
                    )
                ),
            ]
    ...
    #[OA\RequestBody(
        ...
        content: new OA\JsonContent(
            ...
            properties: [
                new OA\Property(property: 'nik', type: 'string', description: 'NIK user / service account', example: '001'),
                new OA\Property(property: 'app_name', type: 'string', description: 'Nama aplikasi yang memakai token', example: 'Aplikasi HRD External'),
                new OA\Property(
                    property: 'abilities',
                    type: 'array',
    ...
    #[OA\Response(
        ...
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'success', type: 'boolean', example: true),
                new OA\Property(property: 'message', type: 'string', example: 'Service token berhasil dibuat. Simpan token ini — tidak akan ditampilkan lagi.'),
                new OA\Property(property: 'token_id', type: 'integer', example: 5),
                new OA\Property(property: 'app_name', type: 'string', example: 'Aplikasi HRD External'),
                new OA\Property(property: 'nik', type: 'string', example: '001'),
                new OA\Property(property: 'abilities', type: 'array', items: new OA\Items(type: 'string'), example: ['*']),
                new OA\Property(property: 'access_token', type: 'string', example: '5|AbCdEfGhIj...'),
    ...
    #[OA\Response(
        ...
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'success', type: 'boolean', example: true),
                new OA\Property(property: 'message', type: 'string', example: 'Token ID 5 berhasil dicabut.'),
            ]
        )
    )]
    #[OA\Response(response: 401, description: 'Unauthenticated')]
