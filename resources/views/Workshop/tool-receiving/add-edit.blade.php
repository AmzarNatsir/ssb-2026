    ...
    <div class="cantainer-fluid">
        <div class="row">
            <div class="col-sm-12 col-lg-12">
                <h1>Tool Receiving</h1>
            </div>
        </div>
        <form  action="{{ isset($toolsReceiving)? route('workshop.tool-receiving.update', $toolsReceiving->id) : route('workshop.tool-receiving.store') }}" method="POST">
            @csrf
            @if (isset($toolsReceiving))
                @method('put')
            @endif
            <div class="row ">
                <div class="col-sm-4">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="supplier_id" id="" class="form-control">
                                            @foreach ($suppliers as $item)
                                                <option {{ isset($toolsReceiving) && $toolsReceiving->supplier_id == $item->id ? 'selected':'' }} value="{{ $item->id }}">{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="remarks" id="" cols="30" rows="3" class="form-control">{{ isset($toolsReceiving) ? $toolsReceiving->description : '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="iq-card">
                        <div class="iq-card-body">
                            ...
                            @if (isset($toolsReceiving))
                                ...
                                @foreach ($toolsReceiving->details as $item)
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
