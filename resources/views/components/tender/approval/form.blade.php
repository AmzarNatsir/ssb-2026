 <div class="modal-content">
     <div class="modal-header">
         <div class="row px-4 pt-2 d-flex flex-column">
             <h5 class="modal-title">Project Approval</h5>
             <p class="font-weight-bold">{{ (isset($project) && count($project) > 0) ? $project[0]['name'] : '' }}</p>
         </div>
         <button type="button" id="closeProjectApprovalModal" data-dismiss="modal" aria-label="Close">
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                         ...
                         {{-- <p>{{ $row->karyawan_id }}</p>
                         <p>{{ auth()->id() }}</p>
                         <p>{{ auth()->user()->id_karyawan }}</p>
                         <p>{{ print_r(auth()->user()->karyawan->id) }}</p> --}}
