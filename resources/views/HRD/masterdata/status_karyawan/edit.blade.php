<div class="iq-card-header d-flex justify-content-between">
    <div class="iq-header-title">
        <h4 class="card-title">Edit Master Status Karyawan</h4>
    </div>
</div>
<div class="iq-card-body">
    <form action="{{ url('hrd/masterdata/statuskaryawan/update/'.$res->id) }}" method="post" onsubmit="return konfirm()">
    {{ csrf_field() }}
    {{ method_field('PUT') }}
        <div class="row align-items-center">
            <div class="form-group col-sm-12">
                <label for="inp_nama">Nama Status Karyawan :</label>
                <input type="text" class="form-control" id="inp_nama" name="inp_nama" maxlength="200" value="{{ $res->nm_status }}" required>
            </div>
            <div class="form-group col-sm-12">
