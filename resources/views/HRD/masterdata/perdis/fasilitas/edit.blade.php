...
<div class="iq-card-body">
    <form action="{{ url('hrd/masterdata/perdis/fasilitas/update/'.$res->id) }}" method="post" onsubmit="return konfirm()">
    {{ csrf_field() }}
    {{ method_field('PUT') }}
        <div class=" row align-items-center">
            <div class="form-group col-sm-12">
                <label for="inp_nama">Nama fasilitas :</label>
                <input type="text" class="form-control" id="inp_nama" name="inp_nama" maxlength="200" value="{{ $res->nm_fasilitas }}" required>
            </div>
