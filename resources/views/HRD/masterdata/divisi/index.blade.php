...
<div class="row">
        ...
        <div class="iq-card" id="page_view">
            <div class="iq-card-header d-flex justify-content-between">
                <div class="iq-header-title">
                    <h4 class="card-title">Input Master Divisi</h4>
                </div>
            </div>
            <div class="iq-card-body">
                <form action="{{ url('hrd/masterdata/divisi/simpan') }}" method="post" onsubmit="return konfirm()">
                {{ csrf_field() }}
                    <div class=" row align-items-center">
                        <div class="form-group col-sm-12">
                            <label for="inp_nama">Nama Divisi :</label>
    ...
    <div class="col-sm-12 col-lg-7">
        <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
                <div class="iq-header-title">
                    <h4 class="card-title">List Master Divisi</h4>
                </div>
            ...
            <div class="iq-card-body" style="width:100%; height:auto">
                <table class="table table-hover">
                    ...
                    <tbody>
                    @if(!empty($list_divisi))
                        @php $nom=1; @endphp
                        @foreach($list_divisi as $list)
                        <tr>
                            <th scope="row">{{ $nom }}</th>
                            ...
                            <td>
                                ...
                                <a href="{{ url('hrd/masterdata/divisi/hapus/'.$list->id) }}" class="btn btn-danger mb-2" onClick="return hapusKonfirm()"><i class="ri-delete-bin-line pr-0"></i></a>
                            </td>
                        </tr>
                        @php $nom++; @endphp
                        @endforeach
...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        {
            var id_data = this.id;
            $("#page_view").load("{{ url('hrd/masterdata/divisi/edit') }}/"+id_data);
        });
    });
    var actExcel = function()
    {
        window.open('{{ route("ExportDivisi") }}');
    }
    function konfirm()
    {
