...
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Dataku - Lembur</li>
        </ul>
    </nav>
</div>
<div class="row">
                        ...
                        <div class="iq-card iq-card-block iq-card-stretch">
                            <div class="iq-card-body p-0">
                                <table class="table" style="width: 100%;" id="table_cuti_izin">
                                    <tr>
                                        <td style="text-align: left; background-color: rgb(5, 120, 250); color: white"><b>DAFTAR LEMBUR</b><div class="user-list-files d-flex float-right"><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#ModalForm" onclick="goFormAdd(this)"
                                            ><i class="fa fa-plus"></i> Pengajuan Lembur</button></div></td>
                                    </tr>
                                    {{-- <tr>
                                        <td id="list_lembur" style="vertical-align: top">
...
<script type="text/javascript">
    ...
    function get_data()
    {
        ...
        $("#list_lembur").load("{{ url('hrd/dataku/getListLembur')}}/"+pil_bulan+"/"+pil_tahun, function(){
            $('#spinner-div').hide();
        });
    }
