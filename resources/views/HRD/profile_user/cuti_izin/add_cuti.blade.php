...
<div class="modal-body">
    <form action="{{ url('hrd/dataku/pengajuanCutiStore') }}" method="post" id="myFormCuti">
    {{ csrf_field() }}
        ...
        {{-- <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="date" name="tgl_masuk" id="tgl_masuk" class="form-control" value="{{ date('Y/m/d') }}" readonly>
            </div>
        </div> --}}
        <div class="form-group row">
...
<script type="text/javascript">
        ...
        $("#pil_jenis_cuti").on("change", function()
        {
            ...
            if(id_pil_jenis==0)
            {
                ...
                $.ajax({
                    ...
                    data : {id_pil_jenis:id_pil_jenis},
                    //dataType: 'json',
        ...
        $("#tgl_akhir").on("change", function()
        {
            ...
            } else if(tgl_2=="")
            {
                ...
                $.ajax({
                    ...
                    {
                        // alert(res);
                        $("#inp_jumlah_hari").val(res.jumlah_hari);
    ...
    document.querySelector('#myFormCuti').addEventListener('submit', function(event) {
