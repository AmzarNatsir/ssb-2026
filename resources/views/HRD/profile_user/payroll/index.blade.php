...
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Dataku - Payroll</li>
        </ul>
    </nav>
</div>
<div class="row">
                        ...
                        <div class="iq-card iq-card-block iq-card-stretch">
                            <div class="iq-card-body p-0">
                                <table class="table" style="width: 100%;" id="table_cuti_izin">
                                    <tr>
                                        <td style="text-align: left; background-color: rgb(5, 120, 250); color: white"><b>PAYROLL</b></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function get_data()
    {
        ...
        $("#list_lembur").load("{{ url('hrd/dataku/getListPayroll')}}/"+pil_tahun, function(){
            $('#spinner-div').hide();
        });
    }
    ...
    {
        var id_data = el.id
        $("#v_form").load("{{ url('hrd/dataku/detailPayroll/')}}/"+id_data, function(){
            $(".angka").number(true, 0);
        });
    }
</script>
