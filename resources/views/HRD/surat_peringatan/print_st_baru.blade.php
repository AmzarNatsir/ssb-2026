        ...
        <table width="100%">
            <tr>
                <td align="left" style="width: 50%;">
                    <img src="{{ url(Storage::url('logo_perusahaan/' . $fl_logo)) }}" alt="Logo" width="100px"
                        width="auto" class="logo" />
                </td>
    ...
    <main>
        ...
        <table style="border: 2px solid black; border-collapse: collapse; width: 100%;" cellpadding='5' class="isi">
            ...
            <tr>
                <td>Departemen</td>
                <td style="text-align: right;">:</td>
                <td><b>{{ $dt_st->get_karyawan->get_departemen->nm_dept }}</b></td>
            </tr>
            <tr>
                <td colspan="3" style="border-top: 2px solid black; border-collapse: collapse;">Sehubungan dengan
                    pelanggaran yang Saudara lakukan, yaitu :</td>
            </tr>
            <tr>
                <td colspan="3"><b>{{ $dt_st->get_jenis_pelanggaran->jenis_pelanggaran }}</b><br><br></td>
            </tr>
            <tr>
                <td colspan="3" style="border-top: 2px solid black; border-collapse: collapse;">Maka sesuai dengan
                    peraturan yang berlaku, kepada Saudara diberikan sanksi berupa <b>SURAT TEGURAN</b><br><br>
            ...
            <tr>
                <td colspan="3" style="border-top: 2px solid black; border-collapse: collapse;">
                    <table style="width: 100%" cellpadding="0">
                        <tr>
                            <td style="width: 33%">Pomalaa, {{ date_format(date_create($dt_st->created_at), 'd') }}
                                {{ \App\Helpers\Hrdhelper::get_nama_bulan(date_format(date_create($dt_st->created_at), 'm')) }}
                                {{ date_format(date_create($dt_st->created_at), 'Y') }}
                            </td>
                        ...
                        <tr>
                            ...
                            <td><b>{{ $dt_st->get_karyawan->nm_lengkap }}</b></td>
                            <td><b>{{ $dt_st->get_current_approve->nm_lengkap }}</b></td>
                        </tr>
                        <tr>
                            <td>{{ $dt_st->get_diajukan_oleh->get_jabatan->nm_jabatan }}</td>
                            <td>{{ $dt_st->get_karyawan->get_jabatan->nm_jabatan }}</td>
                            <td>{{ $dt_st->get_current_approve->get_jabatan->nm_jabatan }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
