    ...
    <tr>
        <td colspan="3" style="border-top: 2px solid black; border-collapse: collapse;">
            <table style="width: 100%" cellpadding="0">
                <tr>
                    <td style="width: 33%">Pomalaa, {{ date_format(date_create($dt_st->created_at), 'd') }} {{ \App\Helpers\Hrdhelper::get_nama_bulan(date_format(date_create($dt_st->created_at), 'm')) }} {{ date_format(date_create($dt_st->created_at), 'Y') }}</td>
