<p>Daftar Surat Teguran Karyawan</p>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="width: 25%; vertical-align: middle">
                <h5 class="mb-0">{{ $list->get_karyawan->nm_lengkap }}</h5>
                ...
                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                            <button type="button" class="dropdown-item tbl-detail-st" id="{{ $list->id }}" data-toggle="modal" data-target="#modalFormPengajuanST" name="btn-detail[]" title="Detail"><i class="fa fa-eye"></i> Detail Pengajuan</button>
                            <a class="dropdown-item" href="{{ url('hrd/suratperingatan/printST', $list->id) }}" target="_new"><i class="fa fa-print mr-2"></i>Print SP</a>
                        </div>
                    </div>
                </div>
            </td>
