           ...
           <div class="row">
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="text-left">
                        ...
                        <p class="mb-0">Pengajuan Penerbitan ST</p>
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="text-left">
                        ...
                        <p class="mb-0">Pengajuan Penerbitan SP</p>
                ...
                <div class="col-md-6 col-lg-2">
                    ...
                    <div class="text-left">
                        <h4>{{ $count_sp_non_aktif }} Orang</h4>
                        <p class="mb-0">SP Non Aktif</p>
                        <button type="button" class="btn btn-success" id="showSPAktif" value="sp_non_aktif" onclick="showData(this)">Tampilkan Data</button>
                    </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-2">
