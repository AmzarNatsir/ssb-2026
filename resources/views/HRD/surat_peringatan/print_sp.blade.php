...
<head>
    ...
    <title>SSB | Smart System Base | HRD | Pelaporan | Surat Peringatan (SP)</title>
    <style>
        @page {
            margin: 0px;
        }
    ...
    <main>
        <table style="width: 100%;" class="isi">
            ...
            <tr>
                ...
                <td style="width: 59%;"><b>{{ $dt_sp->profil_karyawan->nm_lengkap }}</b></td>
            </tr>
            <tr>
                <td>NIK</td>
                <td style="text-align: right;">:</td>
                <td><b>{{ $dt_sp->profil_karyawan->nik }}</b></td>
            </tr>
            <tr>
                <td>Jabatan</td>
                <td style="text-align: right;">:</td>
                <td><b>{{ $dt_sp->profil_karyawan->get_jabatan->nm_jabatan }}</b></td>
            </tr>
            <tr>
                <td colspan="3"></td>
            </tr>
            ...
            <tr>
                ...
                <td style="text-align: right; vertical-align: top;">:</td>
                <td style="vertical-align: top;"><b>{{ $dt_sp->get_master_jenis_sp_disetujui->nm_jenis_sp }}</b></td>
            </tr>
            <tr>
                <td colspan="3" style="height: 30px;"></td>
            </tr>
            ...
            <tr>
                <td colspan="3" style="text-align: right">Pomalaa, {{ date_format(date_create($dt_sp->tgl_sp), 'd') }}
                    {{ \App\Helpers\Hrdhelper::get_nama_bulan(date_format(date_create($dt_sp->tgl_sp), 'm')) }}
                    {{ date_format(date_create($dt_sp->tgl_sp), 'Y') }}
                </td>
            </tr>
        </table>
        <br>
        <table style="width: 100%; border-collapse:collapse; font-size: 12px">
            ...
            <tr>
                <td><b>{{$dt_sp->profil_karyawan->nm_lengkap }}</b></td>
