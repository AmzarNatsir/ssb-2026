...
<main>
    <h3 class="card-title" style="text-align: center;">DATA PERJALANAN DINAS KARYAWAN</h3>
    ...
    <table style="width: 100%; border-collapse:collapse" border="1">
        <thead>
            <tr>
                ...
                <th rowspan="2" style="width: 15%">Jabatan/Departemen</th>
                <th rowspan="2" style="width: 15%">Maksud dan Tujuan</th>
                <th rowspan="2" style="width: 10%;">Lokasi</th>
                <th colspan="2" style="text-align: center;">Tanggal Perjalanan</th>
                <th rowspan="2" style="width: 10%; text-align:right">Total Biaya</th>
                <th rowspan="2" style="width: 10%;">Keterangan</th>
            </tr>
            <tr>
                <th style="text-align: center; width: 10%;">Berangkat</th>
                <th style="text-align: center; width: 10%;">Kembali</th>
            </tr>
        </thead>
        <tbody>
        @if(!empty($list_data))
            ...
            <tr>
                ...
                <td style="text-align:right">Rp. {{ number_format($list->get_fasilitas->sum('sub_total'), 0) }}</td>
