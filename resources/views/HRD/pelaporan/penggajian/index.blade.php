...
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('hrd/pelaporan/penggajian') }}">Data Penggajian (F5)</a></li>
        </ul>
    </nav>
</div>
<div class="row">
...
<script type="text/javascript">
    ...
    var actFilter = function()
    {
        ...
        if(bulan==0)
        {
            ...
            $("#p_preview").load("{{ url('hrd/pelaporan/penggajian/filter') }}/"+bulan+"/"+tahun+"/"+pil_departemen);
        }
    }
