...
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('hrd/pelaporan/pinjamanKaryawan') }}">Data Pinjaman Karyawan (F5)</a></li>
        </ul>
    </nav>
</div>
<div class="row">
        ...
        <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
                <div class="iq-header-title">
                    <h4 class="card-title">Pelaporan Pinjaman Karyawan</h4>
                </div>
            </div>
            ...
            <div class="iq-card-body table-responsive" id="p_preview">
...
<script type="text/javascript">
    ...
    var actFilter = function()
    {
        ...
        if(bulan==0)
        {
            ...
            $("#p_preview").load("{{ url('hrd/pelaporan/pinjamanKaryawan/filter') }}/"+bulan+"/"+tahun+"/"+pil_departemen);
        }
    }
