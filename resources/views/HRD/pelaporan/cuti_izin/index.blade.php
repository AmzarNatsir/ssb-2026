...
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('hrd/pelaporan/mutasi') }}">Data Cuti/Izin Karyawan (F5)</a></li>
        </ul>
    </nav>
</div>
<div class="row">
        ...
        <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
                <div class="iq-header-title">
                    <h4 class="card-title">Pelaporan Data Cuti/Izin Karyawan</h4>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    var actFilter = function()
    {
        ...
        if(bulan==0)
        {
            ...
            $("#p_preview").load("{{ url('hrd/pelaporan/cutiizin/filter') }}/"+bulan+"/"+tahun+"/"+kategori+"/"+pil_departemen);
        }
    }
    var actPrint = function()
    {
        ...
        if(bulan==0)
        {
            ...
            window.open('{{ url("hrd/pelaporan/cutiizin/print") }}/'+bulan+"/"+tahun+"/"+kategori+"/"+pil_departemen);
        }
    }
    var actExcel = function()
    {
        ...
        if(bulan==0)
        {
            ...
            window.open('{{ url("hrd/pelaporan/cutiizin/excel") }}/'+bulan+"/"+tahun+"/"+kategori+"/"+pil_departemen);
        }
    }
</script>
@endsection
