...
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('hrd/pelaporan/mutasi') }}">Data Mutasi (F5)</a></li>
        </ul>
    </nav>
</div>
<div class="row">
        ...
        <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
                <div class="iq-header-title">
                    <h4 class="card-title">Pelaporan Data Mutasi Karyawan</h4>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    var actFilter = function()
    {
        ...
        if(bulan==0)
        {
            ...
            $("#p_preview").load("{{ url('hrd/pelaporan/mutasi/filter') }}/"+bulan+"/"+tahun+"/"+pil_departemen);
        }
    }
    var actPrint = function()
    {
        ...
        if(bulan==0)
        {
            ...
            window.open('{{ url("hrd/pelaporan/mutasi/print") }}/'+bulan+"/"+tahun+"/"+pil_departemen);
        }
    }
    var actExcel = function()
    {
        ...
        if(bulan==0)
        {
            ...
            window.open('{{ url("hrd/pelaporan/mutasi/excel") }}/'+bulan+"/"+tahun+"/"+pil_departemen);
        }
    }
</script>
@endsection
