...
<title>SSB | Smart System Base | HRD | Pelaporan | Surat Peringatan (SP) Karyawan</title>
<style>
    @page {
        margin: 0px;
    }
...
<main>
    <h3 class="card-title" style="text-align: center;">DATA PENERBITAN SP KARYAWAN</h3>
    <p><b>Periode {{ ($ket_bulan=="0") ? "" : $ket_bulan }} {{ $ket_tahun }}</b></p>
    <table style="width: 100%; border-collapse:collapse" border="1">
        <thead>
            <tr>
                <th style="width: 5%; text-align:center">No.</th>
                <th style="width: 25%; text-align:center">Karyawan</th>
                <th style="width: 20%; text-align:center">Surat</th>
                <th style="width: 20%; text-align:center">Tingkatan Sanksi</th>
                <th style="width: 30%; text-align:center">Uraian Pelanggaran</th>
            </tr>
        </thead>
        <tbody>
        @if(!empty($list_data))
            ...
            <tr>
                ...
                <td><b>
                {{ $list->profil_karyawan->nik }} - {{ $list->profil_karyawan->nm_lengkap }}</b><br>
                ...
                <td style="text-align: center">{{ $list->get_master_jenis_sp_disetujui->nm_jenis_sp }}</td>
