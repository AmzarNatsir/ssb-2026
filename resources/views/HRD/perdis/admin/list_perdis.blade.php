...
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('hrd/perjalanandinas') }}">Daftar Pengajuan (F5)</a></li>
        </ul>
    </nav>
</div>
<div class="row">
        ...
        <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
                <div class="iq-header-title">
                    <h4 class="card-title">Daftar Perjalanan Dinas Karyawan</h4>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    var actFilter = function()
    {
        ...
        if(bulan==0)
        {
            ...
            $("#p_preview").load("{{ url('hrd/perjalanandinas/daftarPerjalananDinasFilter') }}/"+bulan+"/"+tahun+"/"+pil_departemen);
        }
    }
</script>
@endsection
