<div class="modal-header">
    <h5 class="modal-title" id="exampleModalCenteredScrollableTitle">Form Persetujuan Perjalanan Dinas - HRD</h5>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    <span aria-hidden="true">×</span>
    </button>
</div>
<form action="{{ url('hrd/perjalanandinas/persetujuan/persetujuanStore_hrd') }}" method="post" onsubmit="return konfirm()">
{{ csrf_field() }}
