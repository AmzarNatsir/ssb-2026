        ...
        <ul id="iq-sidebar-toggle" class="iq-menu">
            ...
            @if (auth()->user()->nik == "999999999")
                    ...
                    <li>
                        ...
                        <ul id="menu-level" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            ...
                            <li>
                                <a href="#masterstruktur" class="iq-waves-effect collapsed" data-toggle="collapse"
                                    aria-expanded="false"><span>Struktur</span><i
                                        class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                            ...
                            <li>
                                <a href="#masterperdis" class="iq-waves-effect collapsed" data-toggle="collapse"
                                    aria-expanded="false"><span>Perjalanan Dinas</span><i
                                        class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    ...
                    <li>
                        ...
                        <ul id="Setup" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            ...
                            <li>
                                <a href="#setupmanajemenpengguna" class="iq-waves-effect collapsed" data-toggle="collapse"
                                    aria-expanded="false"><span>Manajemen Pengguna</span><i
                                        class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                ...
                <li>
                    <a href="#recruitment" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                            class="fa fa-address-book-o"></i><span>Recruitment</span><i
                            class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                ...
                <li>
                    <a href="#Pendataan" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                            class="ri-profile-line"></i><span>Pendataan</span><i
                            class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="Pendataan" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li>
                            <a href="#penggajian" class="iq-waves-effect collapsed" data-toggle="collapse"
                                aria-expanded="false"><span>Penggajian</span><i
                                    class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                ...
                <li>
                    <a href="#pengajuan" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                            class="ri-user-line"></i><span>Pengajuan</span><i
                            class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                ...
                <li>
                    <a href="#pelaporan" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                            class="ri-pie-chart-box-line"></i><span>Pelaporan</span><i
                            class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="pelaporan" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li>
                            <a href="#penggajian_lap" class="iq-waves-effect collapsed" data-toggle="collapse"
                                aria-expanded="false"><span>Penggajian</span><i
                                    class="ri-arrow-right-s-line iq-arrow-right"></i></a>
            ...
            @if(!empty($id_role))
                ...
                @if(auth()->user()->can('master_data_view'))
                    <li>
                        ...
                        <ul id="menu-level" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            ...
                            <li><a href="{{ url('hrd/masterdata/jenisPelanggaran') }}">Jenis Pelanggaran</a></li>
                            <li>
                                <a href="#masterKPI" class="iq-waves-effect collapsed" data-toggle="collapse"
                                    aria-expanded="false"><span>KPI</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                ...
                @if(auth()->user()->can('setup_view'))
                    <li>
                        <a href="#Setup" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                                class="fa fa-gear"></i><span>Setup</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                        <ul id="Setup" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li><a href="{{ url('hrd/setup/harilibur') }}">Pengaturan Hari Libur</a></li>
                            <li>
                                <a href="#setupmanajemenpengguna" class="iq-waves-effect collapsed" data-toggle="collapse"
                ...
                @if(auth()->user()->can('job_description_view'))
                    <li><a href="{{ url('hrd/jobdesc') }}" class="iq-waves-effect"><i class="ri-folder-line"></i><span>Job
                ...
                @if(auth()->user()->can('key_performance_indicator_penyusunan_view') || auth()->user()->can('key_performance_indicator_penilaian_view'))
                    <li>
                        <a href="#performance" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                                class="ri-key-line"></i><span>KPI</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    ...
                    <li>
                        ...
                        <ul id="pendataan" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            ...
                            @if(auth()->user()->can('karyawan_karyawan_bpjs_view'))
                                <li><a href="{{ url('hrd/karyawan/karyawan_bpjs') }}" class="iq-waves-effect"><i
                                            class="ri-user-line"></i><span>Karyawan BPJS</span></a></li>
                            @endif

                            @if(auth()->user()->can('karyawan_perubahan_status_view'))
                                <li><a href="{{ url('hrd/perubahanstatus') }}" class="iq-waves-effect"><i
                                            class="ri-user-line"></i><span>Perubahan Status</span></a></li>
                            @endif
                            @if(auth()->user()->can('karyawan_mutasi_view'))
                                <li><a href="{{ url('hrd/mutasi') }}" class="iq-waves-effect"><i
                                            class="ri-user-line"></i><span>Mutasi</span></a></li>
                            @endif
                            @if(auth()->user()->can('karyawan_cuti_izin_view'))
                                <li><a href="{{ url('hrd/cutiizin') }}" class="iq-waves-effect"><i
                                            class="ri-user-line"></i><span>Cuti/Izin</span></a></li>
                            @endif
                            ...
                            @if(auth()->user()->can('karyawan_perjalanan_dinas_view'))
                                <li><a href="{{ url('hrd/perjalanandinas') }}" class="iq-waves-effect"><i
                                            class="ri-user-line"></i><span>Perjalanan Dinas</span></a></li>
                            @endif
                            @if(auth()->user()->can('karyawan_surat_peringatan_view'))
                                <li><a href="{{ url('hrd/suratperingatan') }}" class="iq-waves-effect"><i
                                            class="ri-user-line"></i><span>Surat Peringatan</span></a></li>
                            @endif
                            @if(auth()->user()->can('karyawan_pinjaman_karyawan_view'))
                                <li><a href="{{ url('hrd/pinjaman_karyawan') }}" class="iq-waves-effect"><i
                                            class="ri-user-line"></i><span>Pinjaman Karyawan</span></a></li>
                            @endif
                            @if(auth()->user()->can('karyawan_lembur_view'))
                                <li><a href="{{ url('hrd/lembur') }}" class="iq-waves-effect"><i
                                            class="ri-user-line"></i><span>Lembur</span></a></li>
                            @endif
                            @if(auth()->user()->can('karyawan_resign_view'))
                                <li><a href="{{ url('hrd/resign') }}" class="iq-waves-effect"><i
                                            class="ri-user-line"></i><span>Resign</span></a></li>
                            @endif
                        </ul>
                    </li>
                ...
                @if(auth()->user()->can('pelatihan_view'))
                    <li>
                        <a href="#pelatihan" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                                class="ri-user-line"></i><span>Pelatihan</span><i
                                class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                ...
                @if(auth()->user()->can('penggajian_view'))
                    <li>
                        <a href="#penggajian" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                                class="ri-user-line"></i><span>Penggajian</span><i
                                class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                        <ul id="penggajian" class="iq-submenu collapse iq-submenu-data">
                ...
                @if(auth()->user()->can('persetujuan_view'))
                    <li><a href="{{ url('hrd/persetujuan') }}" class="iq-waves-effect"><i
                                class="ri-user-line"></i><span>Approval</span></a></li>
                @endif
