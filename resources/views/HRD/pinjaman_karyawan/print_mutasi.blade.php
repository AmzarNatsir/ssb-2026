...
<style>
    ...
    */
    ...
    <table style="width: 100%; border-collapse:collapse; font-size: 12px">
        ...
        <tr>
            <td style="width: 15%; height: 20px;">Nomor</td>
            <td style="width: 2%">:</td>
            <td style="width: 25%">{{ $data->nomor_pinjaman }}</td>
        ...
        <tr>
            ...
            <td style="width: 2%">:</td>
            <td style="width: 25%">{{ $data->getKaryawan->nm_lengkap }}</td>
    ...
    <br>
    <table style="border: 1px solid black; border-collapse: collapse; width: 100%; font-size: 13px" cellpadding="5">
        <thead>
            <td style="width: 5%; text-align: center" class="ln-right">No.</td>
            <td style="width: 20%; text-align: center" class="ln-right">Tgl.Bayar</td>
            <td style="width: 30%; text-align: right" class="ln-right">Nominal</td>
        ...
        <tbody>
            ...
            @endphp
            @foreach ($data->getListPembayaran as $row)
