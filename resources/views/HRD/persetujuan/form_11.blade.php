        ...
        <div class="col-sm-12 col-lg-6">
            <div class="iq-card">
                ...
                <div class="iq-card-body">
                    <ul class="list-group">
                       <li class="list-group-item disabled" aria-disabled="true">NIK : <b>{{ $profil->profil_karyawan->nik }}</b></li>
                       <li class="list-group-item">Nama Karyawan : <b>{{ $profil->profil_karyawan->nm_lengkap }}</b></li>
                       <li class="list-group-item">Jabatan : <b>{{ $profil->profil_karyawan->get_jabatan->nm_jabatan }}</b></li>
                       <li class="list-group-item">Departemen : <b>{{ $profil->profil_karyawan->get_departemen->nm_dept }}</b></li>
                    </ul>
                </div>
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
