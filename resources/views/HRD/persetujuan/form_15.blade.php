<div class="modal-header">
    <h5 class="modal-title" id="exampleModalCenteredScrollableTitle">Form Persetujuan Pengajuan Pengunduran Diri (Resign)</h5>
    ...
    <div class="row">
        <div class="col-sm-12 col-lg-5">
            <div class="iq-card">
                        ...
                        <tbody>
                            <tr>
                                <td style="width: 10%">
                                    ...
                                    <img src="{{ url(Storage::url('hrd/photo/'.$profil->getKaryawan->photo)) }}"
                                ...
                                <td>
                                    <h4 class="mb-0">{{ $profil->getKaryawan->nik }}</h4>
                                    <h4 class="mb-0">{{ $profil->getKaryawan->nm_lengkap }}</h4>
                                    <h6 class="mb-0">{{ $profil->getKaryawan->get_jabatan->nm_jabatan }} | {{ $profil->getKaryawan->get_departemen->nm_dept }}</h6>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <ul class="list-group">
                    <li class="list-group-item disabled" aria-disabled="true">Tanggal Pengajuan : <b><p style="font_size: 12px" class="badge badge-primary">{{ date('d-m-Y', strtotime($profil->created_at)) }}</p></b></li>
                    <li class="list-group-item">Alasan Pengajuan : <br><b>{{ $profil->alasan_resign }}</b></li>
                    <li class="list-group-item">Rencana Efektif Resign Tanggal : <b><p style="font_size: 12px" class="badge badge-danger">{{ date_format(date_create($profil->tgl_eff_resign), 'd-m-Y') }}</p></b></li>
                </ul>
            </div>
        </div>
