...
<div class="modal-header">
    <h5 class="modal-title" id="exampleModalCenteredScrollableTitle">Form Persetujuan Tunjangan Hari Raya (THR)</h5>
            ...
            <div class="iq-card">
                <div class="iq-card-body">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <span>Daftar THR - Periode {{ \App\Helpers\Hrdhelper::get_nama_bulan($profil->bulan) }} {{$profil->tahun }}</span>
                        </div>
                    </div>
                                        ...
                                        <table id="user-list-table-1" class="table-hover table-striped table-bordered datatable2" cellpadding="4" role="grid" aria-describedby="user-list-page-info" style="width: 100%; font-size: 14px">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align: right; width: 10%">Gaji&nbsp;Pokok</th>
                                                    <th style="text-align: right; width: 10%">Tunjangan&nbsp;Tetap</th>
                                    ...
                                    <table id="user-list-table-{{ $r['id'] }}" class="table-hover table-striped table-bordered datatable2" cellpadding="4" role="grid" aria-describedby="user-list-page-info" style="width: 100%; font-size: 14px">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: right; width: 10%">Gaji&nbsp;Pokok</th>
                                                <th style="text-align: right; width: 10%">Tunjangan&nbsp;Tetap</th>
                                                <th style="text-align: right; width: 10%">THP</th>
                                            </tr>
                                        </thead>
                                        <tbody>
