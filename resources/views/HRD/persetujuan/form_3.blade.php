<div class="modal-header">
    <h5 class="modal-title" id="exampleModalCenteredScrollableTitle">Form Persetujuan Pengajuan Cuti</h5>
            ...
            <div class="iq-card">
                ...
                <div class="iq-card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">Alasan Pengajuan : {{ $profil->ket_cuti }}</li>
                        <li class="list-group-item">Rencana Cuti : {{ date_format(date_create($profil->tgl_awal), 'd-m-Y') }} s/d {{ date_format(date_create($profil->tgl_akhir), 'd-m-Y') }}</li>
                        <li class="list-group-item">Jumlah Hari : {{ $profil->jumlah_hari }} hari</li>
                        @if($data_approval->approval_level > 1)
                        <li class="list-group-item">Karyawan Pengganti : {{ (empty($profil->id_pengganti)) ? "" : $profil->get_karyawan_pengganti->nm_lengkap }}</li>
                        @endif
                     </ul>
                </div>
            </div>
