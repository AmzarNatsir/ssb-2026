<div class="modal-header">
    <h5 class="modal-title" id="exampleModalCenteredScrollableTitle">Form Persetujuan Pengajuan Penonaktifan Surat Peringatan</h5>
        ...
        <div class="col-sm-12 col-lg-5">
            <div class="iq-card">
                            ...
                            <tr>
                                <td style="width: 10%">
                                    @if(!empty($profil->getSP->profil_karyawan->photo))
                                        ...
                                        <img src="{{ url(Storage::url('hrd/photo/'.$profil->getSP->profil_karyawan->photo)) }}"
                                ...
                                <td>
                                    <h4 class="mb-0">{{ $profil->getSP->profil_karyawan->nik }}</h4>
                                    <h4 class="mb-0">{{ $profil->getSP->profil_karyawan->nm_lengkap }}</h4>
                                    <h6 class="mb-0">{{ $profil->getSP->profil_karyawan->get_jabatan->nm_jabatan }} | {{ $profil->getSP->profil_karyawan->get_departemen->nm_dept }}</h6>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">Alasan Pengajuan : <b>{{ $profil->alasan_non_aktif }}</b></li>
                    <li class="list-group-item">Masa Berlaku SP : <b>{{ date('d-m-Y', strtotime($profil->getSP->profil_karyawan->sp_mulai_active)) }} s/d {{ date('d-m-Y', strtotime($profil->getSP->profil_karyawan->sp_akhir_active)) }}</b></li>
                        <li class="list-group-item">Uraian Pelanggaran : <b>{{ $profil->getSP->uraian_pelanggaran }}</b></li>
                </ul>
            </div>
        </div>
