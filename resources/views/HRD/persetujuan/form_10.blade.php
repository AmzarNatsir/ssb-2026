<div class="modal-header">
    <h5 class="modal-title" id="exampleModalCenteredScrollableTitle">Form Persetujuan Pengajuan Penerbitan Surat Teguran</h5>
        ...
        <div class="col-sm-12 col-lg-6">
            <div class="iq-card">
                ...
                <div class="iq-card-body">
                    <ul class="list-group">
                       <li class="list-group-item disabled" aria-disabled="true">NIK : {{ $profil->get_karyawan->nik }}</li>
                       <li class="list-group-item">Nama Karyawan : {{ $profil->get_karyawan->nm_lengkap }}</li>
                       <li class="list-group-item">Jabatan : {{ $profil->get_karyawan->get_jabatan->nm_jabatan }}</li>
                       <li class="list-group-item">Departemen : {{ $profil->get_karyawan->get_departemen->nm_dept }}</li>
                    </ul>
                </div>
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                ...
                <div class="iq-card-body">
                    <ul class="list-group">
                        <li class="list-group-item disabled" aria-disabled="true">Tanggal Pengajuan : {{ date_format(date_create($profil->tanggal_pengajuan), 'd-m-Y') }}</li>
                        <li class="list-group-item">Tanggal Kejadian :{{ date('d-m-Y', strtotime($profil->tanggal_kejadian)) }}</li>
                        <li class="list-group-item">Waktu Kejadian : {{ date('H:i', strtotime($profil->waktu_kejadian)) }}</li>
                        <li class="list-group-item">Tempat Kejadian : {{ $profil->tempat_kejadian }}</li>
                        <li class="list-group-item">Jenis Pelanggaran : {{ $profil->get_jenis_pelanggaran->jenis_pelanggaran }}</li>
                        <li class="list-group-item">Akibat pelanggaran tersebut terjadi : {{ $profil->akibat }}</li>
                        <li class="list-group-item">Tindakan perbaikan yang dilakukan setelah kejadian : {{ $profil->tindakan }}</li>
                        <li class="list-group-item">Rekomendasi dari atasan pelanggar : {{ $profil->rekomendasi }}</li>
                        <li class="list-group-item">Komentar dari pelanggaran : {{ $profil->komentar_pelanggar }}</li>
