<div class="modal-header">
    <h5 class="modal-title" id="exampleModalCenteredScrollableTitle">Form Persetujuan Pengajuan Perjalana Dinas</h5>
        ...
        <div class="col-sm-12 col-lg-6">
            <div class="iq-card">
                ...
                <div class="iq-card-body">
                    @include('HRD.persetujuan.profil')
                </div>
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                ...
                <ul class="list-group">
                    <li class="list-group-item disabled" aria-disabled="true">Tanggal Pengajuan : <b>{{ date_format(date_create($profil->tgl_perdis), 'd-m-Y') }}</b></li>
                    <li class="list-group-item">Alasan Pengajuan : <b>{{ $profil->maksud_tujuan }}</b></li>
                    <li class="list-group-item">Tanggal Berangkat : <b>{{ date('d-m-Y', strtotime($profil->tgl_berangkat)) }} s/d {{ date('d-m-Y', strtotime($profil->tgl_kembali)) }}</b></li>
                    <li class="list-group-item">Tujuan : <b>{{ $profil->tujuan }}</b></li>
                    <li class="list-group-item">Diajukan Oleh : <b>{{ $profil->get_diajukan_oleh->nm_lengkap }} - {{ $profil->get_diajukan_oleh->get_jabatan->nm_jabatan }}</b></li>
                    </ul>
            </div>
        </div>
        <div class="col-sm-12 col-lg-6">
