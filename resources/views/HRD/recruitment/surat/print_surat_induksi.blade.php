...
<tr>
    <td style="text-align: center; font-size:15px"><b><u>SURAT PENGANTAR</u></b></td>
</tr>
<tr>
    <td style="text-align: center; font-size:13px"><b>NO. {{ $profil->no_surat_si }}</b></td>
</tr>
<tr><td style="height: 30px;"></td></tr>
<tr>
    <td style="text-align: justify;">Hal : Safety Induction</td>
</tr>
<tr><td style="height: 30px;"></td></tr>
...
<tr>
    <td colspan="3" style="text-align: justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bersama ini kami mengarahkan Karyawan yang baru diterima di PT Sumber Setia Budi untuk mengikuti Safety Induction di Departemen {{ $profil->get_departmen->nm_dept }}. Adapun identitas karyawan tersebut adalah :</td>
</tr>
...
<tr>
    ...
    <td style="width: 1%;; text-align: right;">:</td>
    <td style="width: 69%;"><b>{{ $profil->get_nik_karyawan_baru->nik }}</b></td>
</tr>
<tr>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;Jabatan</td>
...
<tr><td colspan="3" style="height: 20px;"></td></tr>
<tr><td colspan="3">Demikian penyampaian kami atas perhatian dan kerjasamanya terima kasih.</td></tr>
<tr><td colspan="3" style="height: 30px;"></td></tr>
<tr><td colspan="3" style="height: 30px;">Pomalaa, {{ date_format(date_create($profil->tgl_surat_pengantar), 'd') }} {{ \App\Helpers\Hrdhelper::get_nama_bulan(date_format(date_create($profil->tgl_surat_pengantar), 'm')) }} {{ date_format(date_create($profil->tgl_surat_pengantar), 'Y') }}</td></tr>
</table>
<table style="width: 100%;" class="isi">
<tr>
...
<tr>
    <td><b><u>{{ $profil->get_create_by($profil->surat_by)->nm_lengkap }}</u></b></td>
