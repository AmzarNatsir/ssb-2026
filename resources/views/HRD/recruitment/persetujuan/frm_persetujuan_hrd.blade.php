...
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item active">Persetujuan Aplikasi Pelamar | HRD</li>
        </ul>
    </nav>
</div>
<div class="row">
...
<div class="row">
    ...
    <div class="col-sm-12 col-lg-6">
        <div class="iq-card">
            ...
            <div class="iq-card-body">
                <table class="table">
                    ...
                    <tr>
                        <td>Pejabat</td>
                        <td>: {{ $ls_atl->user_by->nm_lengkap }}</td>
                    </tr>
                    <tr>
                        <td>Jabatan</td>
                        <td>: {{ $ls_atl->user_by->get_jabatan->nm_jabatan }}</td>
                    </tr>
                    <tr>
                        <td>Catatan</td>
        ...
        <form action="{{ route('formPersetujaunRecruitmentHRDSimpan') }}" method="post" onsubmit="return konfirm()" enctype="multipart/form-data">
        {{ csrf_field() }}
