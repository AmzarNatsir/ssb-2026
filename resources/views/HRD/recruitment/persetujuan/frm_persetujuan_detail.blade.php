...
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item active">Persetujuan Aplikasi Pelamar | Detail</li>
        </ul>
    </nav>
</div>
<div class="row">
        ...
        <div class="iq-card">
            ...
            <div class="iq-card-body">
                <table class="table">
                    ...
                    <tr>
                        <td>Pejabat</td>
                        <td>: {{ (empty($ls_al->user_by->nm_lengkap)) ? "" : $ls_al->user_by->nm_lengkap }}</td>
                    </tr>
                    <tr>
                        <td>Jabatan</td>
                        <td>: {{ (empty($ls_al->user_by->get_jabatan->nm_jabatan)) ? "" : $ls_al->user_by->get_jabatan->nm_jabatan }}</td>
                    </tr>
                    <tr>
                        <td>Status</td>
                        <td>: {{ ($ls_al->hasil==1) ? "Direkomendasikan" : "Tidak Direkomendasikan" }}</td>
                    </tr>
                    <tr>
                        <td>Catatan</td>
                    ...
                    @endforeach
                    @foreach($persetujuan_atl as $ls_atl)
                        @if(!empty($ls_atl->hasil))
                        <tr>
                            <td colspan="2" class="btn-primary">Persetujuan Atasan Tidak Langsung</td>
                        </tr>
                        <tr>
                            <td style="width: 20%;">Tanggal</td>
                            <td>: {{ date_format(date_create($ls_atl->tanggal_persetujuan), 'd-m-Y') }}</td>
                        </tr>
                        <tr>
                            <td>Pejabat</td>
                            <td>: {{ (empty($ls_atl->user_by->nm_lengkap)) ? "" : $ls_atl->user_by->nm_lengkap }}</td>
                        </tr>
                        <tr>
                            <td>Jabatan</td>
                            <td>: {{ (empty($ls_atl->user_by->get_jabatan->nm_jabatan)) ? "" : $ls_atl->user_by->get_jabatan->nm_jabatan }}</td>
                        </tr>
                        <tr>
                            <td>Status</td>
                            <td>: {{ ($ls_atl->hasil==1) ? "Direkomendasikan" : "Tidak Direkomendasikan" }}</td>
                        </tr>
                        <tr>
                            <td>Catatan</td>
                            <td>: {{ $ls_atl->keterangan }}</td>
                        </tr>
                        @endif
                    @endforeach

                    @foreach($persetujuan_hrd as $ls_hrd)
                        @if(!empty($ls_hrd->hasil))
                        <tr>
                            <td colspan="2" class="btn-primary">Persetujuan HRD</td>
                        </tr>
                        <tr>
                            <td style="width: 20%;">Tanggal</td>
                            <td>: {{ date_format(date_create($ls_hrd->tanggal_persetujuan), 'd-m-Y') }}</td>
                        </tr>
                        <tr>
                            <td>Pejabat</td>
                            <td>: {{ (empty($ls_hrd->user_by->nm_lengkap)) ? "" : $ls_hrd->user_by->nm_lengkap }}</td>
                        </tr>
                        <tr>
                            <td>Jabatan</td>
                            <td>: {{ (empty($ls_hrd->user_by->get_jabatan->nm_jabatan)) ? "" : $ls_hrd->user_by->get_jabatan->nm_jabatan }}</td>
                        </tr>
                        <tr>
                            <td>Status</td>
                            <td>: {{ ($ls_hrd->hasil==1) ? "Direkomendasikan" : "Tidak Direkomendasikan" }}</td>
                        </tr>
                        <tr>
                            <td>Catatan</td>
                            <td>: {{ $ls_hrd->keterangan }}</td>
                        </tr>
                        @endif
                    @endforeach
                    <tr>
                        <td colspan="2" class="btn-success">Posisi/Jabatan</td>
                    </tr>
                    <tr>
