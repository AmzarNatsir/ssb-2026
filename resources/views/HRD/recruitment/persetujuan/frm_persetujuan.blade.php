...
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item active">Persetujuan Aplikasi Pelamar | Atasan Langsung</li>
        </ul>
    </nav>
</div>
<div class="row">
...
<div class="row">
                ...
                <div class="iq-accordion career-style faq-style">
                    ...
                    <div class="iq-card iq-accordion-block ">
                        <div class="active-faq clearfix">
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-12"><a class="accordion-title"><span><i class="fa fa-graduation-cap"></i> Data Keluarga </h4><p>Latar Belakang Keluarga (Ayah, Ibu & Saudara)</p></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="iq-card iq-accordion-block ">
                        <div class="active-faq clearfix">
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-12"><a class="accordion-title"><span><i class="fa fa-graduation-cap"></i> Data Keluarga </h4><p>(Suami/Istri & Anak)</p></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="iq-card iq-accordion-block ">
                        <div class="active-faq clearfix">
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-12"><a class="accordion-title"><span><i class="fa fa-graduation-cap"></i> Pengalaman Organisasi</h4></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="iq-card iq-accordion-block ">
                        <div class="active-faq clearfix">
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-12"><a class="accordion-title"><span><i class="fa fa-graduation-cap"></i> Pengalaman Kerja</h4></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="iq-card iq-accordion-block ">
                        <div class="active-faq clearfix">
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-12"><a class="accordion-title"><span><i class="fa fa-graduation-cap"></i> Dokumen</h4></a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="col-sm-12 col-lg-6">
        <form action="{{ route('formPersetujaunRecruitmentSimpan') }}" method="post" onsubmit="return konfirm()" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <div class="iq-card">
            ...
            <div class="iq-card-body">
                <div class="form-group row">
                    <label for="lbl_posisi" class="col-sm-12">Jabatan/Posisi Yang Dilamar : <b>{{ $profil->get_jabatan->nm_jabatan }}</b></label>
                </div>
                <hr>
                <div class="form-group row">
