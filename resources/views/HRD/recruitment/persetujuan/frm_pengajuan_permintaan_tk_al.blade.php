...
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Persetujuan Atasan Langsung</li>
        </ul>
    </nav>
</div>
<div class="row">
    <div class="col-sm-12 col-lg-12">
        ...
        <div class="iq-card">
            ...
            <div class="iq-card-body" style="width:100%; height:auto">
                ...
                <form action="{{ url('hrd/recruitment/pengajuan_tenaga_kerja/persetujuan_atasan_langsung_store/'.$detail_pengajuan->id) }}" method="post" onsubmit="return konfirm()">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <div class="form-group row">
