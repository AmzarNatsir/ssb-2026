...
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Persetujuan HRD</li>
        </ul>
    </nav>
</div>
<div class="row">
        ...
        <div class="iq-card">
            ...
            <div class="iq-card-body" style="width:100%; height:auto">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">{{ $detail_pengajuan->user_al->nm_lengkap }}</div>
                </div>
                <div class="form-group row">
                ...
                <hr>
                <div class="form-group row">
                    <label class="col-sm-12"><b><u>Persetujuan Atasan Tidak Langsung</u></b></label>
                </div>
                <div class="form-group row">
                    <label for="req_catatan_appr" class="col-sm-3">Tanggal Persetujuan :</label>
                    <div class="col-sm-9">{{ date_format(date_create($detail_pengajuan->tanggal_approval_atl), 'd-m-Y') }}</div>
                </div>
                <div class="form-group row">
                    <label for="req_catatan_appr" class="col-sm-3">Nama Atasan Tidak Tangsung :</label>
                    <div class="col-sm-9">{{ $detail_pengajuan->user_atl->nm_lengkap }}</div>
                </div>
                <div class="form-group row">
                    <label for="req_catatan_appr" class="col-sm-3">Jabatan :</label>
                    <div class="col-sm-9">{{ $detail_pengajuan->user_atl->get_jabatan->nm_jabatan }}</div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3">Status Persetujuan :</label>
                    <div class="col-sm-2">
                        <div class="custom-control custom-radio">
                            <input type="radio" id="status_appr_al_1" name="status_appr_al" class="custom-control-input" value="1" {{ ($detail_pengajuan->status_approval_atl == 1) ? "checked": "" }} disabled>
                            <label class="custom-control-label" for="status_appr_al_1"> Setuju</label>
                        </div>
                    </div>
                    <div class="col-sm-7">
                        <div class="custom-control custom-radio">
                            <input type="radio" id="status_appr_al_2" name="status_appr_al" class="custom-control-input" value="2" {{ ($detail_pengajuan->status_approval_atl == 2) ? "checked": "" }} disabled>
                            <label class="custom-control-label" for="status_appr_al_2"> Tidak Setuju</label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="req_catatan_appr" class="col-sm-3">Catatan Persetujuan :</label>
                    <div class="col-sm-9">{{ $detail_pengajuan->desk_approval_atl }}</div>
                </div>
                <hr>
                <div class="form-group row">
                    <label class="col-sm-12"><b><u>Persetujuan</u></b></label>
                </div>
                <form action="{{ url('hrd/recruitment/pengajuan_tenaga_kerja/persetujuan_hrd_store/'.$detail_pengajuan->id) }}" method="post" onsubmit="return konfirm()">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <div class="form-group row">
                    <label class="col-sm-3">Status Persetujuan :</label>
