<form action="{{ route('updateOrganisasi', $result->id) }}" method="post" onsubmit="return konfirm()" enctype="multipart/form-data">
{{ csrf_field() }}
{{ method_field('PUT') }}
        ...
        <div class="iq-card-body">
            <div class="row align-items-center">
                <div class="form-group col-sm-12">
                    ...
                    <input type="text" class="form-control" name="inp_nama" id="inp_nama" maxlength="150" value="{{ $result->nama_organisasi }}" required>
                </div>
            </div>
            <div class="row align-items-center">
                <div class="form-group col-sm-12">
