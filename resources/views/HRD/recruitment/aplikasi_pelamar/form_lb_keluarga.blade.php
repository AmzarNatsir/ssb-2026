...
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item">Data Latar Belakang Keluarga</li>
        </ul>
    </nav>
</div>
<div class="row">
        ...
        <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
                <div class="iq-header-title">
                    <h4 class="card-title">Data Latar Belakang Keluarga (Ayah/Ibu & Saudara)</h4>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-5" id="page_view">
                            <div class="iq-card">
                                <form action="{{ url('hrd/recruitment/aplikasi_pelamar/frm_lb_keluarga/simpan') }}" method="post" onsubmit="return konfirm()" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                        ...
                        <div class="col-sm-7">
                            <div class="iq-card">
                                <div class="iq-card-header d-flex justify-content-between">
                                    <div class="iq-header-title">
                                        <h4 class="card-title">Daftar Latar Belakang Keluarga (Ayah, Ibu & Saudara)</h4>
                                    </div>
                                </div>
                                <div class="iq-card iq-card-block iq-card-stretch">
                                    <div class="iq-card-body">
                                        <table class="table table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                <a href="{{ route('deleteDataLBKeluarga', $lbk->id)}}" class="btn btn-danger" onClick="return hapusKonfirm()"><i class="ri-delete-bin-line"></i></a>
                                                </td>
                                            </tr>
                                            @php $nom++; @endphp
                                            @endforeach
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenteredScrollableTitle">Form Edit Data Latar Belakang Keluarga</h5>
...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        {
            var id_data = this.id;
            $("#bodyForm").load('{{ url("hrd/recruitment/aplikasi_pelamar/frm_lb_keluarga/edit") }}/'+id_data);
        });
    });
    function konfirm()
    {
