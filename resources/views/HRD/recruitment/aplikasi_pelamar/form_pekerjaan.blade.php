...
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item">Data Pengalaman Kerja</li>
        </ul>
    </nav>
</div>
<div class="row">
                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-5" id="page_view">
                            <div class="iq-card">
                                <form action="{{ route('insertPekerjaan') }}" method="post" onsubmit="return konfirm()" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="iq-card-body">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <input type="text" class="form-control" name="inp_alamat" id="inp_alamat" maxlength="150" required>
                                                </div>
                                            </div>
                                            <div class="row align-items-center">
                                                <div class="form-group col-sm-12">
                                    ...
                                    <div class="iq-card-body">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <button type="button" id="{{ $krj->id }}" class="btn btn-primary btn_edit" data-toggle="modal" data-target="#ModalEdit"><i class="ri-pencil-line"></i></button>
                                                <a href="{{ route('deletePekerjaan', $krj->id)}}" class="btn btn-danger" onClick="return hapusKonfirm()"><i class="ri-delete-bin-line"></i></a>
                                                </td>
                                            </tr>
                                            @php $nom++; @endphp
                                            @endforeach
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenteredScrollableTitle">Form Edit Data Pengalaman Kerja</h5>
...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        {
            var id_data = this.id;
            $("#bodyForm").load('{{ url("hrd/recruitment/aplikasi_pelamar/frm_pekerjaan/edit") }}/'+id_data);
        });
    });
    function konfirm()
    {
