...
<div class="row">
    ...
    <div class="col-sm-12 col-lg-8 p-2">
        <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
               <div class="iq-header-title">
                  <h4 class="card-title">Daftar Kebutuhan Tenaga Kerja</h4>
               </div>
            </div>
...
<script type="text/javascript">
    ...
    {
        $("#v_pengajuan").load("{{ url('hrd/recruitment/aplikasi_pelamar/list_kebutuhan_tk') }}/"+val);
    }
    var goRekap = function(el)
    {
        var id_data = $(el).val();
        $("#v_detail").load("{{ url('hrd/recruitment/aplikasi_pelamar/rekap_hasil_tes_per_kebutuhan') }}/"+id_data);
    }
