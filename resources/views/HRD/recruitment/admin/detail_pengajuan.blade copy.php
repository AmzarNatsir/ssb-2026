...
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('hrd/recruitment/daftar_pengajuan_tenaga_kerja') }}">Daftar Pengajuan Permintaan Tenaga Kerja</a></li>
    ...
    <div class="col-sm-12 col-lg-12">
        ...
        <div class="iq-card">
            ...
            <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                    <input type="text" class="form-control" value="{{ $detail_pengajuan->get_departemen->nm_dept }}" disabled>
                    </div>
                </div>
                <div class="form-group row">
