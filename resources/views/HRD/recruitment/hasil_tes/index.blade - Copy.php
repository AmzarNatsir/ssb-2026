        ...
        <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
                <div class="iq-header-title">
                    <h4 class="card-title">Pelaporan Penggajian Karyawan</h4>
                </div>
            </div>
            <div class="iq-card-body" style="width:100%; height:auto">
                <div class="row justify-content-between">
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div id="user_list_datatable_info" class="dataTables_filter">
                            <select class="form-control" name="pil_jabatan" id="pil_jabatan" style="width: 100%">
            ...
            <div class="iq-card-body table-responsive">
                <table id="rekap-list-table" class="table table-sm table-responsive table-hover table-striped table-bordered mt-4" role="grid" aria-describedby="user-list-page-info" style="width: 100%; font-size: 12px">
                    <thead>
                        <tr>
                            <th style="text-align: center; width: 4%; vertical-align: middle" rowspan="3">No</th>
                            <th style="width: 15%; text-align: center; vertical-align: middle" rowspan="3">Nama</th>
                            <th style="width: 5%; text-align: center; vertical-align: middle" rowspan="3">Usia</th>
                            <th style="text-align: center; width: 10%; vertical-align: middle" rowspan="3">Pendidikan Terakhir</th>
...
<script type="text/javascript">
    ...
    var actFilter = function()
    {
        ...
        } else if(jabatan==0)
        {
            ...
            tableAjax.draw(); //$("#p_preview").load("{{ url('hrd/recruitment/rekap_hasil_tes/filter') }}/"+departemen+"/"+jabatan);
        }
    }
    var actPrint = function()
    {
        ...
        if(jabatan==0)
        {
            alert("Kolom pilihan Jabatan Tidak boleh kosong");
            return false
        }
        window.open('{{ url("hrd/pelaporan/penggajian/print") }}/'+bulan+"/"+tahun+"/"+pil_departemen);
    }
    var actExcel = function()
    {
        ...
        window.open('{{ url("hrd/pelaporan/penggajian/excel") }}/'+bulan+"/"+tahun+"/"+pil_departemen);
    }
</script>
@endsection
