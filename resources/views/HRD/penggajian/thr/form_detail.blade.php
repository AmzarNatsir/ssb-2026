...
<input type="hidden" name="periode_bulan" id="periode_bulan" value="{{ (empty($periode->bulan)) ? "" : $periode->bulan }}">
<input type="hidden" name="periode_tahun" id="periode_tahun" value="{{ (empty($periode->tahun)) ? "" : $periode->tahun }}">
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        <ul class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ url('hrd/home') }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ url('hrd/thr_karyawan') }}">Tunjangan Hari Raya (THR)</a></li>
        <li class="breadcrumb-item active" aria-current="page">Detail Tunjangan Hari Raya (THR)</li>
        </ul>
    </nav>
</div>
<div class="row">
           ...
           <div class="iq-card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="todo-date d-flex mr-3">
                        ...
                        <span>Daftar Tunjangan Hari Raya Periode {{ \App\Helpers\Hrdhelper::get_nama_bulan($periode->bulan) }} {{ $periode->tahun }}</span>
                    </div>
                </div>
           </div>
        </div>
...
<script>
    var getData = function(el)
    {
        ...
        var tableAjax = new DataTable('#listPayroll-'+id_dept, {
            ajax: {
                url: "{{ url('hrd/thr_karyawan/getDataThr') }}",
                // type: "POST",
                headers: {
    ...
    var goPengaturan = function(el)
    {
        ...
        var link = document.createElement("a")
            link.href = "{{ url('hrd/thr_karyawan/detailPengaturan') }}/"+id_data+"/"+bulan+"/"+tahun
            link.target = "_blank"
            link.click()
    }
</script>
