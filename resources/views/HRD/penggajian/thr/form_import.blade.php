...
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('hrd/thr_karyawan') }}">Daftar Tunjangan Hari Raya (THR)</a></li>
        <li class="breadcrumb-item active" aria-current="page">Tools | Import Database Pemberian THR</li>
        </ul>
    </nav>
</div>
...
@endif
<form action="{{ url('hrd/thr_karyawan/doImportPeriodeThr') }}" method="post" onsubmit="return konfirm()" enctype="multipart/form-data">
{{ csrf_field() }}
                ...
                <div class="form-group">
                    <div class="alert alert-primary" role="alert">
                        <div class="iq-alert-text">
                            ...
                            <p class="mb-0">Pastikan file excel yang akan diimport sesuai dengan template database THR karyawan. Template dapat didownload di halaman utama</p>
                        </div>
                    </div>
                </div>
            </div>
