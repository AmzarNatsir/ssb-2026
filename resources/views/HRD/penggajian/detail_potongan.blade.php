                ...
                <div class="col-sm-12 col-lg-12">
                    ...
                    <table class="table" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td style="text-align: right">{{ (empty($payroll->bpjstk_jkk_karyawan)) ? 0 : number_format($payroll->bpjstk_jkk_karyawan, 0) }}</td>
                        </tr>
                        <tr>
                        ...
                        @php
                            $bpks_kes = (empty($payroll->bpjsks_karyawan)) ? 0 : $payroll->bpjsks_karyawan;
                            $bpjstk_jht_karyawan = (empty($payroll->bpjstk_jht_karyawan)) ? 0 : $payroll->bpjstk_jht_karyawan;
                            $bpjstk_jkk_karyawan = (empty($payroll->bpjstk_jkk_karyawan)) ? 0 : $payroll->bpjstk_jkk_karyawan;
                            $bpjstk_jp_karyawan = (empty($payroll->bpjstk_jp_karyawan)) ? 0 : $payroll->bpjstk_jp_karyawan;
                            $pot_sedekah = (empty($payroll->pot_sedekah)) ? 0 : $payroll->pot_sedekah;
                            $pot_pkk = (empty($payroll->pot_pkk)) ? 0 : $payroll->pot_pkk;
                            $pot_air = (empty($payroll->pot_air)) ? 0 : $payroll->pot_air;
                            $pot_rumah = (empty($payroll->pot_rumah)) ? 0 : $payroll->pot_rumah;
                            $pot_toko_alif = (empty($payroll->pot_toko_alif)) ? 0 : $payroll->pot_toko_alif;
                            $total_potongan = $bpks_kes + $bpjstk_jht_karyawan + $bpjstk_jkk_karyawan + $bpjstk_jp_karyawan + $pot_sedekah + $pot_pkk + $pot_air + $pot_rumah + $pot_toko_alif
                        @endphp
                        <tr>
