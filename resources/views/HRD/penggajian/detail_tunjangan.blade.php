        ...
        <div class="iq-card">
            <div class="row">
                <div class="col-sm-12 col-lg-12">
                    ...
                    <tr>
                        <td style="width: 50%">Tunjangan Perusahaan (BPJS)</td>
                        <td style="text-align: right">{{ (empty($payroll->pot_tunj_perusahaan)) ? 0 : number_format($payroll->pot_tunj_perusahaan, 0) }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Bonus</td>
                        <td style="text-align: right">{{ (empty($payroll->bonus)) ? 0 : number_format($payroll->bonus, 0) }}</td>
                    </tr>
                    <tr>
                        <td style="width: 50%"><b>Total Tunjangan</b></td>
                        <td style="text-align: right"><b>{{ (empty($payroll->tunj_perusahaan)) ? 0 : number_format($payroll->tunj_perusahaan, 0) }}</b></td>
                    </tr>
                    </table>
                </div>
            </div>
