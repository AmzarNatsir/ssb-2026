                ...
                <div class="form-group">
                    <div class="alert alert-primary" role="alert">
                        <div class="iq-alert-text">
                            ...
                            <p class="mb-0">Pastikan file excel yang akan diimport sesuai dengan template database periode penggajian karyawan. Template dapat didownload di halaman utama periode penggajian</p>
                        </div>
                    </div>
                </div>
            </div>
