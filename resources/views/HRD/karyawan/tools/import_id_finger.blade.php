...
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Tools | Import ID Finger Karyawan</li>
        </ul>
    </nav>
</div>
...
@endif
<form action="{{ route('doImportIDFingerKaryawan') }}" method="post" onsubmit="return konfirm()" enctype="multipart/form-data">
{{ csrf_field() }}
<div class="row">
    <div class="col-lg-4">
        <div class="iq-card">
                ...
                <div class="form-group">
                    <div class="alert alert-primary" role="alert">
                        <div class="iq-alert-text">
                            ...
                            <p>Download Template ID Finger Karyawan dibawah ini :</p>
                            <p><button class="btn btn-primary" name="tbl_download_template" id="tbl_download_template" onClick="actTemplate();"><i class="fa fa-download"></i> Template Database ID Finger</button></p>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    var actTemplate = function()
    {
        window.open('{{ url("hrd/karyawan/downloadtemplateIDFinger") }}');
    }
