...
<div class="navbar-breadcrumb">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Karyawan BPJS</li>
...
@endif
@include('HRD.karyawan.bpjs.summary_bpjs')
<div class="row">
    <div class="col-sm-12 col-lg-12">
        <div class="iq-card">
...
<div id="modalFormSetting" class="modal fade bg-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenteredScrollableTitle" aria-hidden="true" data-backdrop="false">
...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        $(".select2").select2();
        $(".data_karyawan").load("{{ url('hrd/karyawan/karyawan_bpjs_filter_all') }}");
    });
    var actFilter = function(el)
    {
        $('#spinner-div').show();
        var id_departemen = $(el).val();
        $(".data_karyawan").load("{{ url('hrd/karyawan/karyawan_bpjs_filter_departemen') }}/"+id_departemen, function(){
            $('#spinner-div').hide();
        });
    }
    var actFilterGender = function(el)
    {
        ...
        $(".data_karyawan").load("{{ url('hrd/karyawan/karyawan_bpjs_filter_departemen_gender') }}/"+id_departemen+"/"+gender, function(){
            $('#spinner-div').hide();
        });
    }
    var goFormSetting = function(id)
    {
        $('#v_form').load("{{ url('hrd/karyawan/karyawan_bpjs_setting') }}/"+id);
    }
</script>
@endsection
