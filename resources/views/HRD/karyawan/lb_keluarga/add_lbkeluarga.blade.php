                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-5" id="page_view">
                            <form action="{{ url('hrd/karyawan/simpanlbkeluarga') }}" method="post" onsubmit="return konfirm()" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <div class="flex align-items-center list-user-action">
                                                    <a class="btn_edit" id="{{ $lbk->id }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{ url('hrd\karyawan\editlbkeluarga') }}\{{ $lbk->id }}"><i class="ri-pencil-line"></i></a>
                                                    <a data-toggle="tooltip" data-placement="top" title="" data-original-title="Hapus" href="{{ url('hrd\karyawan\hapuslbkeluarga') }}/{{$lbk->id}}/{{$res->id}}" onClick="return hapusKonfirm()"><i class="ri-delete-bin-line"></i></a>
                                                </div>
                                                </td>
                                            </tr>
                                            @php $nom++; @endphp
