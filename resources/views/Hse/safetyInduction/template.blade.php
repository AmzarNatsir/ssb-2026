  ...
  <div class="iq-card-body" style="padding:1.5rem 3rem;">
    <div class="row">
      <div class="col-sm-8">
        <h4 class="card-title text-primary">
          <span class="ri-chat-check-line pr-2"></span>Template Quesioner
        </h4>
      </div>
      <div class="col-sm-4 text-right">
        @hasrole('safety_officer')
          <button id="createProjectBtn" type="button" class="btn btn-lg mb-3 btn-primary rounded-pill font-weight-bold" data-toggle="modal" data-backdrop="static" data-target="#createProjectModal">
            <i class="las la-plus"></i>Create New Template
          </button>
        @endhasrole
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="form-group">
          <input id="searchFilter" name="searchFilter" class="form-control form-control-sm pl-3" type="text" placeholder="Filter Berdasarkan No Dokumen" />
        </div>
      </div>
    </div>
    ...
    <div class="row">      
      <div class="col-12 mt-2">        
        <table id="table-template" class="table table-data nowrap w-100">
          <thead>
            <tr class="tr-shadow">
              <th></th>
              <th>No. Dokumen</th>
...
<script src="{{ asset('js/hse/safetyInduction-template.js') }}"></script>