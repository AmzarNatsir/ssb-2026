...
@include('Hse.safetyInduction.partials.safetyInduction_modal')
@section('content')
<div class="row">
    ...
    <div class="row">
      <div class="col-sm-8">
        <h4 class="card-title text-primary">
          <span class="ri-chat-check-line pr-2"></span>Daftar Safety Induction
        </h4>
      </div>
      <div class="col-sm-4 text-right">
        
          <button id="createSafetyInductionReportBtn" type="button" class="btn btn-lg mb-3 btn-success rounded-pill font-weight-bold" data-toggle="modal" data-backdrop="static" data-target="#createSafetyInductionReportModal">
            <i class="las la-plus"></i>Buat Report Safety Induction
          </button>
...
<script src="{{ asset('js/hse/safetyInduction.js') }}"></script>
