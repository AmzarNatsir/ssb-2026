...
class CreateHrdRecrNilaiOperator extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hrd_recr_nilai_operator', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('hrd_recr_nilai_operator');
    }
}
