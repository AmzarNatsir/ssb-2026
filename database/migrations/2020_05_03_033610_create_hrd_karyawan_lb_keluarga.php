...
class CreateHrdKaryawanLbKeluarga extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hrd_karyawan_lb_keluarga', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('hrd_karyawan_lb_keluarga');
    }
}
